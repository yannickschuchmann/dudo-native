                ...
                <Grid style={{ alignItems: 'center'}}>
                    ...
                    <Row size={45} style={{ marginLeft:'5%' }}>
                        <Col>
                            ...
                            >
                                <Text style={styles.LogoutButtonText}>{this.state.lang_spanish}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                            ...
                            >
                                <Text style={styles.LogoutButtonText}>{this.state.lang_german}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                            ...
                            >
                                <Text style={styles.LogoutButtonText}>{this.state.lang_english}</Text>
                            </Button>
                        </Col>
                    </Row>
                    <Row size={15}>
                        ...
                        >
                            <Text style={styles.LogoutButtonText}>{this.state.logout_button}</Text>
                        </Button>
                    </Row>
                </Grid>
