...
class PlayerCarousel extends Component {
    ...
    _renderItem = ({ item }) => (
        <Card
            style={[(item.is_current) ? styles.selectedPlayer : styles.notSelectedPlayer]}
        >
            <Avatar
            ...
            <Text
                ...
                style={[(item.is_current) ? styles.selectedPlayerTitleText : styles.notSelectedPlayerTitleText]}
            >
                {`${item.name}`}
            </Text>
        </Card>
